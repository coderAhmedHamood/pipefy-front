...
INSERT INTO permissions (name, resource, action, description) VALUES
  ...
  -- صلاحيات Tickets (التذاكر) - 6 صلاحيات
  ...
  ('عرض التذاكر الخاصة بالموظف فقط', 'tickets', 'view_scope', 'التحكم في ما إذا كان المستخدم يرى تذاكر الجميع أو تذاكره الخاصة فقط'),
  -- تم حذف: ('عرض جميع التذاكر', 'tickets', 'view_all', 'عرض جميع التذاكر في النظام'),
  
  -- صلاحيات Recurring Rules (قواعد التكرار) - 1 صلاحية
  ('إدارة قواعد التكرار', 'recurring_rules', 'manage', 'إنشاء وإدارة قواعد التكرار التي تنشئ تذاكر تلقائياً في تواريخ محددة'),
