...
**مثال على الطلب:**
```bash
curl -X GET "http://localhost:3004/api/notifications/all?limit=10&is_read=false" \
...
**مثال على الطلب:**
```bash
curl -X GET "http://localhost:3004/api/notifications/with-users?limit=5" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
**مثال على الطلب:**
```bash
curl -X GET "http://localhost:3004/api/notifications/user/789e0123-e45f-67g8-h901-234567890123?limit=10" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
**مثال على الطلب:**
```bash
curl -X GET "http://localhost:3004/api/notifications/123e4567-e89b-12d3-a456-426614174000" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
