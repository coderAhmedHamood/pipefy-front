...
/**
 * @swagger
 * /api/reports/processes/{process_id}/completed-tickets:
 *   get:
 *     summary: تقرير التذاكر المنتهية لعملية محددة
 *     description: |
 *       يجلب جميع التذاكر المنتهية في عملية محددة خلال فترة زمنية محددة.
 *       التذكرة تعتبر منتهية إذا:
 *       - `completed_at` له قيمة (NOT NULL)
 *       - أو المرحلة الحالية `is_final = true`
 *       
 ...
 *                 message:
 *                   type: string
 *                   example: "تم جلب 15 تذكرة منتهية في العملية"
 *                 data:
 *                   type: object
 *                   properties:
 *                     process:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get('/processes/:process_id/completed-tickets',
  authenticateToken,
  ReportController.getCompletedTicketsForProcessReport
);
