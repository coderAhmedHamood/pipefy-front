# ✅ حل مشكلة المنفذ 3004 على Windows

## المشكلة
```
EACCES: permission denied 0.0.0.0:3004
ERR_CONNECTION_REFUSED
```

## السبب
- المنفذ 3004 يحتاج صلاحيات إدارية على بعض أنظمة Windows
...
بدلاً من المنفذ 3004، استخدم المنفذ 5000:
...
## ملاحظات
- إذا كنت تريد استخدام المنفذ 3004، شغل PowerShell كـ Administrator
