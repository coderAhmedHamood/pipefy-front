# ✅ حل مشكلة المنفذ 3003 على Windows

## المشكلة
```
EACCES: permission denied 0.0.0.0:3003
ERR_CONNECTION_REFUSED
```

## السبب
- المنفذ 3003 يحتاج صلاحيات إدارية على بعض أنظمة Windows
...
بدلاً من المنفذ 3003، استخدم المنفذ 5000:
...
## ملاحظات
- إذا كنت تريد استخدام المنفذ 3003، شغل PowerShell كـ Administrator
