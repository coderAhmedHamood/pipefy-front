...
import { Bell, Clock, ChevronRight, Info, CheckCircle, AlertTriangle, AlertCircle, CheckCheck, Search } from 'lucide-react';
        ...
        <div className="mt-3">
          <div className="relative">
            ...
            <input
              ...
              className={`w-full ${isMobile || isTablet ? 'px-3 py-2 pr-10 text-xs' : 'px-4 py-2 pr-10 text-sm'} border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent`}
            />
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        {notifications.length === 0 && !isLoading ? (
          ...
          <div className="divide-y divide-gray-100">
            ...
            }).length === 0 && searchQuery && notifications.length > 0 && (
              <div className={`${isMobile || isTablet ? 'p-4' : 'p-8'} text-center`}>
