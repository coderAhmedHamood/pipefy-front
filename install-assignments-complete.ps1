# سكريبت تطبيق نظام الإسنادات والمراجعين بالكامل

Write-Host "╔════════════════════════════════════════════════════════╗" -ForegroundColor Cyan
Write-Host "║   🚀 تطبيق نظام الإسنادات والمراجعين - تلقائي    ║" -ForegroundColor Cyan
Write-Host "╚════════════════════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "📂 قراءة الملف..." -ForegroundColor Yellow
$content = Get-Content $filePath -Raw -Encoding UTF8

# التحقق من أن الكود لم يُضف مسبقاً
if ($content -match "Assignments & Reviewers Section") {
    Write-Host "⚠️  النظام مُضاف بالفعل!" -ForegroundColor Yellow
    Write-Host "   لا حاجة لإعادة التطبيق." -ForegroundColor Gray
    exit 0
}

Write-Host "✅ الملف جاهز للتحديث" -ForegroundColor Green
Write-Host ""
...
Write-Host "📝 [1/2] إضافة قسم UI للإسنادات والمراجعين..." -ForegroundColor Cyan
...
$marker1 = "            {/* Comments Section */}"
$content = $content -replace [regex]::Escape($marker1), ($uiSection + "`r`n`r`n" + $marker1)

Write-Host "   ✅ تم إضافة قسم UI" -ForegroundColor Green

# ============================================
# الجزء 2: إضافة Modals
# ============================================

Write-Host "📝 [2/2] إضافة Modals..." -ForegroundColor Cyan
...
# إضافة Modals
$marker2 = "      {/* Attachment Delete Confirmation Dialog */}"
$content = $content -replace [regex]::Escape($marker2), ($modalsSection + "`r`n`r`n" + $marker2)
Write-Host "   ✅ تم إضافة Modals" -ForegroundColor Green
...
Write-Host "║          ✅ اكتمل التطبيق 100% بنجاح!              ║" -ForegroundColor Green
Write-Host "╚════════════════════════════════════════════════════════╝" -ForegroundColor Green
Write-Host ""
Write-Host "🎉 تم إضافة نظام الإسنادات والمراجعين بنجاح!" -ForegroundColor Green
Write-Host ""
Write-Host "📍 الخطوات التالية:" -ForegroundColor Cyan
Write-Host "   1. أعد تشغيل التطبيق: npm run dev" -ForegroundColor Yellow
Write-Host "   2. افتح أي تذكرة في المتصفح" -ForegroundColor Yellow
Write-Host "   3. ستجد قسمين جديدين:" -ForegroundColor Yellow
Write-Host "      - 👥 المستخدمين المُسندين" -ForegroundColor White
Write-Host "      - 🛡️ المراجعين" -ForegroundColor White
Write-Host ""
Write-Host "🧪 للاختبار:" -ForegroundColor Cyan
Write-Host "   node test-ticket-assignments-system.js" -ForegroundColor Yellow
Write-Host ""
